...
💡 Поради:
• Можна вказувати дати: "до 2022", "після 2023"
• Використовуй прізвиська замість імен
• Натисни кнопку контексту для перегляду"""
